            ...
            if (results1.length > 0) {
                ...
                pool.query(Query, function (error, results2, fields) {
                    ...
                    if (results2.length > 0) {
                        ...
                        pool.query('UPDATE online_agents set status_code = ?, last_status_changed = ?, is_updated = ? WHERE agent_code = ?', [status_code, new Date(), '1', agent_code], function (error, results3, fields) {
